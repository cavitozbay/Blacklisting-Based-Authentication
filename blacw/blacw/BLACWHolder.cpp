...
BLACWHolder::BLACWHolder(PFC& _bn, BLACWIssuer& issuer) : 
...
BLACWHolder::~BLACWHolder()
{
}

vector<G2> BLACWHolder::receive_cred1(ZKP1& zkp)
{
...
BOOL BLACWHolder::receive_cred2(vector<G2>& C_pre, Big& v, Sigma& _sigma, Big& esk_issuerS, G2& w)
{
    //G2 CS[3];
...
void BLACWHolder::borrow1(Big& vS, Big& gamma, Big& c0, Big& c1, Witness& wit, vector<G2>& C_pre, G2* _C, Sigma& _sigma, Big& bidS, ZKP2& zkp)
{
...
void BLACWHolder::precompute_h0s(size_t d)
{
    pcomp_d = d;
    pcomp_rem = d;
    pcomp_h0s = vector<G1>();
...
void BLACWHolder::pcomp_borrow1(Big& vS, Big& gamma, Big& c0, Big& c1, Witness& wit, vector<G2>& C_pre, G2* _C, Sigma& _sigma, Big& bidS, ZKP2& zkp)
{   
    if(pcomp_rem == 0)
    {
...
BOOL BLACWHolder::borrow2(vector<G2>& C_pre, Sigma& _sigma_pr, Big& esk_issuerS, G2& w)
{
    G2 tmp1 = bn.mult(com.gens[1], modmult(cred.u,esk_issuerS,bn.order()));
...
void BLACWHolder::repay1(Big& bid, G2& C_1S, G2* C_pr, Sigma& sigma_pr, Big& s, ZKP3& zkp)
{
    Big yS;
...
BOOL BLACWHolder::repay2(Sigma& sigma_prD, G2& C_1S, Big& s, Big& v_p)
{
...
void BLACWHolder::prepare_ZKP1(ZKP1& zkp, CmOp& cmop, G2& G)
{
    vector<Big> alpha_ts;
    //vector<G2> u_ts;
...
void BLACWHolder::prepare_ZKP2(ZKP2& zkp, Credential& credS, vector<G2> C_pre, Big& bidS, Witness& wit)
{
...
void BLACWHolder::prepare_ZKP3(ZKP3& zkp, Big& yS, Big& s, Big& bid, G2& C_pr1, G2& C_1S)
{
...
void BLACWHolder::new_bid(vector<Big>& vecbig, vector<ZZn>& veczzn)
{
    modulo(bn.order());
...
void BLACWHolder::add_bid(Big& bid, vector<Big>& vecbig, vector<ZZn>& veczzn)
{
    modulo(bn.order());
...
void BLACWHolder::remove_bid(Big& bid, vector<Big>& vecbig, vector<ZZn>& veczzn)
{
    modulo(bn.order());
