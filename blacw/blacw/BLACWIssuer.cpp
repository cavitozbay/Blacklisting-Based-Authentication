...
BLACWIssuer::BLACWIssuer(PFC& _bn, G2& _g, G1& _g_hat, TLP& _tlp) : 
...
BLACWIssuer::~BLACWIssuer()
{
}

BOOL BLACWIssuer::issue_cred(vector<G2>& C_pre, Big& esk_issuerS, Sigma& sigma, Big& v, ZKP1& zkp)
{
...
BOOL BLACWIssuer::lend(vector<G2>& C_pre, G2* C, Big& c0, Big& c1, Sigma& sigma, Big& esk_issuerS, Sigma& sigma_pr, ZKP2& zkp)
{
...
BOOL BLACWIssuer::credit(Big& bid, G2& C_1S, G2* C_pr, Sigma& sigma_pr, Sigma& sigma_prD, Big v_p, ZKP3& zkp)
{
...
BOOL BLACWIssuer::verify_ZKP1(ZKP1& zkp, vector<G2>& C_pre)
{
    //ZKP Verification
...
BOOL BLACWIssuer::verify_ZKP2(ZKP2& zkp, vector<G2>& C_pre, G2* C)
{
...
BOOL BLACWIssuer::verify_ZKP3(ZKP3& zkp, G2& C_pre1, G2& C_1S, Big& bid)
{
    Big c = H1(zkp.C_y_t);
